...
const links = [
  { name: 'Home', href: '/scout', icon: UserIcon },
  { name: 'Professionals', href: '/scout/professionals', icon: UsersIcon },
  { name: 'Chat', href: '/scout/chat', icon: ChatBubbleLeftRightIcon },
  { name: 'Posts', href: '/scout/posts', icon: BriefcaseIcon },
