...
<div className="border-1 shadow-lg rounded-lg">

    <div className="flex rounded-t-lg bg-top-color sm:px-2 w-full">
        <div className="h-40 w-40 overflow-hidden sm:rounded-full sm:relative sm:p-0 top-10 left-5 p-3">
            <img src="https://th.bing.com/th/id/OIG2.DDopHvPVZAOevVzq8uh0?pid=ImgGn"/>
        </div>
        ...
        <div className="w-2/3 sm:text-center pl-5 mt-10 text-start">
            ...
            <p className="text-heading">Pais</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:mt-10">
            ...
            <div className="flex flex-col sm:w-1/3 pr-4">
                ...
                <div className="py-3 sm:order-none order-3">
                    <h2 className="text-lg font-poppins font-bold text-top-color">Redes</h2>
                    ...
                    <div>
                        <div className="flex items-center my-1">
                            ...
                            <div className="ml-2 truncate">scout32@gmail.com</div>
                        </div>
                        <div className="flex items-center my-1">
                        ...
                        <div className="flex items-center my-1">
                            ...
                            <div>Nombre Scout||Club21</div>
                        </div>

                    </div>
                    <div className="py-3">
                    <h2 className="text-lg font-poppins font-bold text-top-color">Sobre el Club || Scout</h2>
                    <div className="border-2 w-20 border-top-color my-3"></div>
            ...
            <div className="flex flex-col sm:w-2/3 order-first sm:order-none sm:-mt-10">
                ...
                <div className="py-3">
                    <h2 className="text-lg font-poppins font-bold text-top-color">Contrataciones</h2>
                    <div className="border-2 w-20 border-top-color my-3"></div>

                    <div className="flex flex-col">

                        <div className="flex flex-col border border-gray-500 border-2 rounded-lg p-4 shadow-sm">
                            <p className="text-lg font-bold text-gray-700">Entrenador</p>
                            <p className="font-semibold text-sm text-gray-700">3 meses</p>
                            <p className="font-semibold text-sm text-gray-700 mt-2 mb-1">Sueldo</p>
                        ...
                        <div className="flex flex-col mt-8 border border-gray-500 rounded-lg border-2 p-4 shadow-sm">
                            <p className="text-lg font-bold text-gray-700">Fisioterapeuta</p>
                            <p className="font-semibold text-sm text-gray-700">Indefinido</p>
                            <p className="font-semibold text-sm text-gray-700 mt-2 mb-1">Sueldo</p>
                            <ul className="text-sm list-disc pl-4 space-y-1">
                                <li>Enfocado en ...</li>
                                <li>Disponibilidad ...</li>
